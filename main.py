...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, logged_in=current_user.is_authenticated, user=current_user)
...
def delete_post(post_id):
    ...
    db.session.commit()
    return redirect(url_for('get_all_posts'), logged_in=current_user.is_authenticated, user=current_user)
